        ...
        <main class="container">
            ...
            <form action="php/feedback.php" method="POST" class="admission-form">
                <div class="student-details">
                    ...
                    <br><br>
                    <label>Mobile No 1
                        <input type="text" name="mob1" id="mob1" maxlength="10" required>
                    </label>
                    <br><br>
                    <label>Mobile No 2
                        <input type="text" name="mob2" id="mob2" maxlength="10">
                    </label>
                    <br><br>
                    <label>Email
                ...
                <div class="hostel-details">
                    ...
                    <label>8) Cast Validity
                        ...
                        <p>*If caste certificate issued by Indian Govt.</p>
                    </label>
                ...
                <div class="submit-form">
                    <input type="submit" name="submit" value="Update Details" id="submit">
                </div>
            </form>
            <br>
        </main>
